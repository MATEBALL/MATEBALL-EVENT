...
export const questions = {
  start: {
    ...
    options: [
      { text: '열정응원러', subtitle: '응원가 따라하며 가는 팀', value: 'passionate', icon: '🔥' },
      { text: '직관먹방러', subtitle: '야구장 역시 치맥이지', value: 'foodie', icon: '🍗' },
      { text: '경기 집중러', subtitle: '야구장은 야구를 보러 가는지', value: 'focused', icon: '⚾' },
    ],
  },
  passionate: {
    title: '여유롭게 이기고 있었는데 화장실 갔다 온 사이에 역전된 상황에서 나는?',
    options: [
  ...
  foodie: {
    ...
    options: [
      { text: '화가 나지만 맥주 한 캔 마시면 진정 가능', value: 'calm_with_beer' },
